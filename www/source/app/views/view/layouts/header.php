...
<head>
    ...
    <link rel="icon" href="source/uploads/icon.png">
    <link href="source/app/views/view/index.css" rel="stylesheet">
    ...
    <script src="source/app/views/view/index.js" type="application/javascript"></script>
